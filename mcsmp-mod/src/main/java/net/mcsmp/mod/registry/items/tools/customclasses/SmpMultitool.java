...
/*
public class SmpMultitool extends MiningToolItem {

}
     protected static final Map<Block, Block> STRIPPED_BLOCKS;

    protected SmpMultitool(ToolMaterial material, int attackDamage, float attackSpeed, Item.Settings settings) {
        super((float)attackDamage, attackSpeed, material, BlockTags.AXE_MINEABLE, settings);
    }
